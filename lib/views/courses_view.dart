          ...
          return StatefulBuilder(builder: (ctx2, setState) {
            return AlertDialog(
              ...
              content: Column(mainAxisSize: MainAxisSize.min, children: [
                Text('Curso seleccionado: #$cursoId',
                    style: const TextStyle(fontWeight: FontWeight.w600)),
                const SizedBox(height: 8),
                if (studs.isNotEmpty)
                  DropdownButtonFormField<int>(
                    initialValue: sel,
                    items: studs.map<DropdownMenuItem<int>>((s) {
        ...
        children: [
          Row(
            children: [
              ...
              IconButton(
                  onPressed: _loadCourses, icon: const Icon(Icons.refresh)),
                  ...
                  onPressed: () async {
                    ...
                    try {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                          content: Text('Error fetching estudiantes: $e')));
                      return;
                    }
          ...
          Expanded(
            child: _courses.isEmpty
                ? const Center(
                    child: Text('No tienes cursos. Crea uno desde tu perfil.'))
                : ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      if (query.isNotEmpty) {
                        ...
                        displayed = displayed.where((s) {
                          ...
                          final a =
                              (s['apellido'] ?? '').toString().toLowerCase();
                          ...
                          children: [
                            ...
                            if (studs != null && displayed.isNotEmpty)
                              ...displayed.map<Widget>((s) {
                                final sid = s['estudiante_id'] ?? s['id'] ?? 0;
